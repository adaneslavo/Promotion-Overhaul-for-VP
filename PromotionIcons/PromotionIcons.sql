...
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_CARGO_I';
	UPDATE UnitPromotions SET PortraitIndex = '18' WHERE Type = 'PROMOTION_CARGO_I';
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_CARGO_II';
	UPDATE UnitPromotions SET PortraitIndex = '19' WHERE Type = 'PROMOTION_CARGO_II';
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_CARGO_III';
	UPDATE UnitPromotions SET PortraitIndex = '20' WHERE Type = 'PROMOTION_CARGO_III';
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_CARGO_IV';
	UPDATE UnitPromotions SET PortraitIndex = '20' WHERE Type = 'PROMOTION_CARGO_IV';
UPDATE UnitPromotions SET IconAtlas = 'PROMOTION_ATLAS' WHERE Type = 'PROMOTION_AIR_SWEEP';
	UPDATE UnitPromotions SET PortraitIndex = '9' WHERE Type = 'PROMOTION_AIR_SWEEP';
UPDATE UnitPromotions SET IconAtlas = 'PROMOTION_ATLAS' WHERE Type = 'PROMOTION_AIR_RECON';
	UPDATE UnitPromotions SET PortraitIndex = '37' WHERE Type = 'PROMOTION_AIR_RECON';
UPDATE UnitPromotions SET IconAtlas = 'PROMOTION_ATLAS' WHERE Type = 'PROMOTION_PARADROP';
	UPDATE UnitPromotions SET PortraitIndex = '33' WHERE Type = 'PROMOTION_PARADROP';
--90
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_HOVERING_UNIT';
	UPDATE UnitPromotions SET PortraitIndex = '0' WHERE Type = 'PROMOTION_HOVERING_UNIT';
UPDATE UnitPromotions SET IconAtlas = 'PROMOTION_ATLAS' WHERE Type = 'PROMOTION_FLAT_MOVEMENT_COST';
	UPDATE UnitPromotions SET PortraitIndex = '33' WHERE Type = 'PROMOTION_FLAT_MOVEMENT_COST';
UPDATE UnitPromotions SET IconAtlas = 'PROMOTION_ATLAS' WHERE Type = 'PROMOTION_SEE_INVISIBLE_SUBMARINE';
	UPDATE UnitPromotions SET PortraitIndex = '39' WHERE Type = 'PROMOTION_SEE_INVISIBLE_SUBMARINE';
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_INTERCEPTION_I';
	UPDATE UnitPromotions SET PortraitIndex = '15' WHERE Type = 'PROMOTION_INTERCEPTION_I';
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_INTERCEPTION_II';
	UPDATE UnitPromotions SET PortraitIndex = '16' WHERE Type = 'PROMOTION_INTERCEPTION_II';
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_INTERCEPTION_III';
	UPDATE UnitPromotions SET PortraitIndex = '17' WHERE Type = 'PROMOTION_INTERCEPTION_III';
UPDATE UnitPromotions SET IconAtlas = 'EXPANSION2_PROMOTION_ATLAS' WHERE Type = 'PROMOTION_INTERCEPTION_IV';
	UPDATE UnitPromotions SET PortraitIndex = '17' WHERE Type = 'PROMOTION_INTERCEPTION_IV';