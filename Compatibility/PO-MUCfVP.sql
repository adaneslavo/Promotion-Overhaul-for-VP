...
UPDATE Language_en_US SET Text = '[COLOR:140:155:255:255]Santa María[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_UNIT_SPAIN_SANTA_MARIA' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-MUCfVP' AND Value=1);
