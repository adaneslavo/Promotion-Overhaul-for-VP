...
-- Main Compatibility Code
	...
	UPDATE Language_en_US SET Text = '+1 [ICON_VISION] Sight.' WHERE Tag = 'TXT_KEY_PROMOTION_SCOUTING_3_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-AT' AND Value= 1);
