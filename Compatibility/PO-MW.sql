...
-- Main Compatibility Code
	...
	-- Promotion Help
	------------------------------
	UPDATE Language_en_US SET Text = '+1 [ICON_VP_VISION] Sight. Double[ICON_MOVES]Movement and +10%[ICON_STRENGTH]CS [COLOR:255:230:85:255]on Hills[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_ALTITUDE_TRAINING_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-MW' AND Value= 1);
