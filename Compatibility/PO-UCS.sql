...
-- Main Compatibility Code
	...
	UPDATE Language_en_US SET Text = '+5%[ICON_STRENGTH]Offensive CS/[ICON_RANGED_STRENGTH]Offensive RCS. +10%[ICON_STRENGTH]Offensive CS/[ICON_RANGED_STRENGTH]Offensive RCS [COLOR:255:230:85:255]in Forest[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_KARASJOHKA_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	...
	UPDATE Language_en_US SET Text = '+3[ICON_STRENGTH]CS. +15%[ICON_STRENGTH]Offensive CS [COLOR:255:230:85:255]vs Units at or below 50% HP[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_KNIFE_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '+20%[ICON_STRENGTH]CS [COLOR:255:230:85:255]inside Friendly Territory[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_DISC_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '+3[ICON_STRENGTH]CS. When attacked, [COLOR:255:230:85:255]unit returns 10% of the damage taken[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_TRIDENT_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '+4[ICON_STRENGTH]CS. +20%[ICON_STRENGTH]CS [COLOR:255:230:85:255]vs Wounded Units[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_DAGGER_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '+3[ICON_STRENGTH]CS. +15%[ICON_STRENGTH]CS [COLOR:255:230:85:255]vs Units with full Health[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_BOW_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '+4[ICON_STRENGTH]CS. Before melee Attack [COLOR:255:230:85:255]unit performs an additional Range attack[ENDCOLOR] at 50% of its [ICON_STRENGTH]CS.' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_MUSKET_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	...
	UPDATE Language_en_US SET Text = '+2[ICON_STRENGTH]CS. +10%[ICON_STRENGTH]Defensive CS. +15 HP.' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_CHAINMAIL_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	...
	UPDATE Language_en_US SET Text = '+3[ICON_STRENGTH]CS. +1[ICON_MOVES]Movement Point. [COLOR:255:230:85:255]On Move[ENDCOLOR] unit inflicts 5 Damage [COLOR:255:230:85:255]to all new adjacent Enemy Land Units[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_SHOES_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '+4[ICON_STRENGTH]CS. [COLOR:255:230:85:255]On Kill[ENDCOLOR] unit advances and inflicts 10 Damage [COLOR:255:230:85:255]to all new adjacent Enemy Land Units[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_MARTIAL_ART_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '+1[ICON_STRENGTH]CS. +1[ICON_VIEW_CITY]Sight. +25% XP [COLOR:255:230:85:255]on Fight[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_TURBAN_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '+6[ICON_STRENGTH]CS. Unit gains even more [ICON_PEACE] [COLOR:255:230:85:255]on Kill[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_BRACELET_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
