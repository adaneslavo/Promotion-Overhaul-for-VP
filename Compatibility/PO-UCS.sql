...
-- Main Compatibility Code
	...
	UPDATE Language_en_US SET Text = '[COLOR:235:85:145:255]Blessing of Clermont (Clermont)[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_CLERMONT1' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '[COLOR:235:85:145:255]Onward with Haste! (Clermont)[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_CLERMONT2' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '[COLOR:235:85:145:255]United We Stand! (Clermont)[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_CLERMONT3' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '[COLOR:235:85:145:255]Charge! (Clermont)[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_CLERMONT4' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '[COLOR:235:85:145:255]Reinforce! (Clermont)[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_CLERMONT5' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '[COLOR:235:85:145:255]Glory to God! (Clermont)[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_CLERMONT6' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	UPDATE Language_en_US SET Text = '[COLOR:235:85:145:255]Deus Vult! (Clermont)[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_CLERMONT7' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	...
	UPDATE Language_en_US SET Text = '[COLOR:6:82:255:255]astar Bunga[ENDCOLOR]' WHERE Tag = 'TXT_KEY_PROMOTION_SIKH_TURBAN' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
