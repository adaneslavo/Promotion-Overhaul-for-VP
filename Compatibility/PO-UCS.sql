...
-- Main Compatibility Code
	...
	UPDATE Language_en_US SET Text = 'Unit gains +5% [ICON_PRODUCTION] Production if it [COLOR:255:230:85:255]is Garrisoned on Land[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_AMBRACIA_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);
	...
	UPDATE Language_en_US SET Text = 'Unit gains [ICON_RESEARCH] Science [COLOR:255:230:85:255]on Kill[ENDCOLOR].' WHERE Tag = 'TXT_KEY_PROMOTION_FAYA_HELP' AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='PO-UCS' AND Value= 1);	
